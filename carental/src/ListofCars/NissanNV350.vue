<template>
 ...
 <!-- Navigation Bar -->
  ...
  <div class="container mt-4">
    <div class="row align-items-center ">
     <div class="col">
  <h1 class="text-center" style="color: #000; font-weight: bold;">Nissan NV350 Urvan<img src="@/assets/Nissan_2020_logo.png" alt="Logo" width="50"></h1>
  </div>
    </div>
  </div>
 ...
 <div class="card card-hover" style="position: relative; width: 700px; height: 480px; margin-left: -80px; background-color: #F0F0F0; border-color: #D9D9D9;">
    <div class="card-body">
      <img src="@/assets/nissan.png" alt="Car" style="max-width: 100%; max-height: 100%; transition: transform 0.3s ease;">
      ...
      <div class="col-md-6">
        ...
        <table class="table table-striped mt-1" style="border-collapse: collapse; border: 1px solid #D9D9D9;"> <!-- Adjusted width of the table -->
          <tbody>
            ...
            <tr>
              <td style="border: 1px solid #D9D9D9;">Power Wndows</td>
