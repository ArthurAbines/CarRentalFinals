<template>
  ...
  <div v-if="showModal" class="modal fade show d-block" tabindex="-1" style="background: rgba(0, 0, 0, 0.5); position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
    <div class="modal-dialog modal-dialog-centered">
      ...
      <!--Overview -->
        ...
        <p>
           The BMW X7 is a full-size luxury SUV that combines impressive performance, opulent comfort, and advanced technology.
        </p>
        </div>
    </div>
  </div>
        ...
        <table class="table table-striped mt-1" style="border-collapse: collapse; border: 1px solid #D9D9D9;"> <!-- Adjusted width of the table -->
          <tbody>
            ...
            <tr>
              ...
              <td style="border: 1px solid #D9D9D9;">7</td>
            </tr>
             <tr>
            ...
            <tr>
              ...
              <td style="border: 1px solid #D9D9D9;">83 Liters</td>
            </tr>
            <tr>
 ...
 <div class="col-md-6">
  ...
  <table class="table table-striped mt-1" style="border-collapse: collapse; border: 1px solid #D9D9D9;"> <!-- Adjusted width of the table -->
    <tbody>
      <tr>
        <td style="border: 1px solid #D9D9D9;">Luxurious Interior</td>
        <td style="border: 1px solid #D9D9D9;">Complex Controls</td>
      </tr>
      <tr>
        <td style="border: 1px solid #D9D9D9;">Spacious Cabin</td>
        <td style="border: 1px solid #D9D9D9;">Fuel Economy</td>
      </tr>
      <tr>
        <td style="border: 1px solid #D9D9D9;">Powerful Engine</td>
        <td style="border: 1px solid #D9D9D9;">Limited Cargo Space</td>
      </tr>
      <tr>
        <td style="border: 1px solid #D9D9D9;">Smooth Ride</td>
